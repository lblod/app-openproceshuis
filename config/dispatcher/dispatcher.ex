defmodule Dispatcher do
  ...
  match "/versioned-processes/*path",  %{ accept: [:json], layer: :api } do
    Proxy.forward conn, path, "http://cache/versioned-processes/"
  end
  ...
  match "/process-domains/*path", %{ accept: [:json], layer: :api } do
    Proxy.forward conn, path, "http://cache/process-domains/"
  end

  match "/process-categories/*path", %{ accept: [:json], layer: :api } do
  ...
  match "/diagram-lists/*path", %{ accept: [:json], layer: :api } do
