...
(supply-allowed-group "is-vendor-json-api-user"
  ...
  :query "PREFIX ext: <http://mu.semte.ch/vocabularies/ext/>    
          ...
          WHERE {
            ...
            ?bestuurseenheid mu:uuid ?graph_extension .
          }")

(grant (read write)
       :to-graph sessions
       :for-allowed-group "is-vendor-json-api-user")
